...
trait CasperMessageProtocol {
  ...
  // Bootstrap data
  implicit final val bootstrapDataFromPacket =
    protoImpl[PacketTypeTag.BootstrapData.type, BootstrapDataProto]
  ...
  // Bootstrap data
  implicit final val bootstrapDataToPacket =
    protoSerde[PacketTypeTag.BootstrapData.type, BootstrapDataProto]
